...
export const ScrewToggle: React.FC<ScrewToggleProps> = (props) => {
    const uniqueId = React.useId();
    const steelId = `paint_linear_steel_${uniqueId}`;
    const noiseFilterId = `noise-filter_${uniqueId}`;
    const noisePatternId = `noise-pattern_${uniqueId}`;
    const noiseId = `noise_${uniqueId}`;

    return (
        <div className="st-area">
            <div className="st-bg">
                <div className="st-light-1"></div>
                <div className="st-light-2"></div>
                <div className="st-light-3"></div>
            </div>

            <label className="st-area-wrapper">
                <div className="st-wrapper">
                    <input type="checkbox" {...props} />
                    <div className="st-button">
                        <div className="st-part-1">
                            <div className="st-case">
                                <div className="st-mask"></div>
                                <div className="st-line"></div>
                            </div>
                            <div className="st-screw">
                                <svg
                        ...
                        <div className="st-part-2">
                            ...
                            <div className="st-glass">
                                <div className="st-glass-reflex"></div>
                                <svg
                                    viewBox="0 0 700 700"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="st-glass-noise"
                                >
                                    <defs>
                                        <filter
                                ...
                                <svg
                                    ...
                                    height="52"
                                    width="49"
                                    className="st-filament st-filament-on"
                                >
                                    <path
                                        stroke="white"
                                        d="M32.5 26.1085C32.5 26.1085 32 5.90019 38.5 2.10852C45 -1.68315 49 5.10852 47.5 9.60852C46 14.1085 39.5 17.1085 21 18.1085C13.667 18.5049 6.49118 18.0371 0.5 17.328"
                                ...
                                <svg
                                    ...
                                    height="52"
                                    width="49"
                                    className="st-filament st-filament-blur st-filament-on"
                                >
                                    <path
                                        stroke="currentColor"
                                        d="M32.5 26.1085C32.5 26.1085 32 5.90019 38.5 2.10852C45 -1.68315 49 5.10852 47.5 9.60852C46 14.1085 39.5 17.1085 21 18.1085C13.667 18.5049 6.49118 18.0371 0.5 17.328"
                ...
                <svg height="100%" width="100%">
                    <defs>
                        ...
                        >
                            ...
                            <rect filter={`url(#${noiseId})`} height="500" width="500"></rect>
                        </pattern>
                    </defs>
                    <rect fill={`url(#${noisePatternId})`} height="100%" width="100%"></rect>
                </svg>
            </div>
        </div>
    );
